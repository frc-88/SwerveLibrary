...
public class TestUtils {
  ...
  /**
   * Junit assert equals for Vector2Ds, with default floating point tolerance. Compares magnitude
   * and angle.
   *
   * @param expected The expected value
   * @param actual The actual value
  ...
  /**
   * Junit assert equals for velocity states, with default floating point tolerance. Compares
   * field-centricitiy, translation velocity, rotation velocity, and center of rotation
   *
   * @param expected The expected value
   * @param actual The actual value
   */
