...
public class ToRobotCentricTest {

    @Mock
    private Gyro gyro;

    private ToRobotCentric modifier;

    @BeforeEach
    public void setup() {
        MockitoAnnotations.initMocks(this);

        modifier = new ToRobotCentric(gyro);
    }
    ...
    public void testApplyFullVelocityFieldCentric() {
        ...
        FullVelocityMotionState expectedState = initialState.makeRobotCentric()
                .changeTranslationVelocity(initialState.getTranslationVelocity().changeAngle(new WrappedAngle(30.)));
