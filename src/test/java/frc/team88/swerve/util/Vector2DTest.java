...
public class Vector2DTest {
    ...
    public void testRotateNegative() {
        assertVectorEquals(Vector2D.createPolarCoordinates(1, new WrappedAngle(-15)), deg30.rotate(-45));
    }
    ...
    public void testLimitChangeRestrictedSameAngle() {
        ...
        assertVectorEquals(Vector2D.createPolarCoordinates(4, new WrappedAngle(50)), current.limitChange(target, 1));
    }
    ...
    public void testLimitChangeRestrictedOppositeAngle() {
        ...
        assertVectorEquals(Vector2D.createPolarCoordinates(1, new WrappedAngle(-120)), current.limitChange(target, 3));
    }
