...
public class VelocityState implements NetworkTablePopulator {
   ...
   *
   * @param translationDirection The direction to translate, in degrees counting counterclockise
   *     from forwards.
   ...
   *
   * @return The translation direction, in degrees counterclockwise from forwards.
   */
  ...
  public Vector2D getTranslationVector() {
    return Vector2D.createPolarCoordinates(
        this.getTranslationSpeed(), new WrappedAngle(this.getTranslationDirection()));
  }
  ...
  /**
   * Creates a new velocity state that is the same as this one, except with the given translation
   * direction.
   *
   * @param direction The translation direction, in degrees counterclockwise from forwards.
  ...
  public VelocityState changeTranslationDirection(double direction) {
    return new VelocityState(
        ...
        this.centerOfRotationX,
        this.centerOfRotationY,
        this.isFieldCentric);
  }
  ...
  /**
   * Creates a new velocity state that is the same as this one, except with the given rotation
   * velocity.
   *
  ...
  /**
   * Creates a new velocity state that is the same as this one, except with the given field-centric
   * setting.
   *
   * @param isFieldCentric True if the velocity state should be field-centric, false if it should be
   *     robot-centric.
   * @return The new velocity state.
   */
