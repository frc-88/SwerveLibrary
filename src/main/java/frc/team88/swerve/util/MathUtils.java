...
public class MathUtils {
   ...
   * @param maxChange The maximum amount that the returned value can differ from the current value
   * @return The value that is as close to the desired value as possible without exceeing the
   *     maximum change
   */
