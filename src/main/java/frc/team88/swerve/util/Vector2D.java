...
public class Vector2D {
  ...
  /**
   * Limits the magnitude of the difference between this vector and the returned vector when trying
   * to go from this vector to the desired vector.
   *
   * @param desired The desired vector
   * @param maxChange The maximum amount that the returned vector can differ from this vector
   * @return The vector that is as close to the desired vector as possible without exceeing the
   *     maximum change
   */
